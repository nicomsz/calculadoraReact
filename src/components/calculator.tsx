    ...
    return (
      ...
      <div className='bg-dark-blue rounded-3xl h-[32rem] w-80 box hover:shadow-2xl border border-black border-2 font-last-calc'>
        ...
        <div className="flex flex-col">
          ...
          <div className="self-end font-last-calc text-4xl mx-4 "> 2 </div>
        </div>
        <div className="grid grid-cols-4 col-span-5 gap-[12px] mx-0 max-w-[320px] mt-[4rem] mx-5 ">
            ...
            <button className="rounded-full w-[60px] h-[60px] bg-result-button shadow-button font-last-calc">=</button>
